class Keyboard{
  ...
  #keyboardHTML() {
    return `
      ...
      <div class="white_key" data-key="D4"></div>
      <div class="black_key b2" data-key="D#4 / Eb4"></div>
      <div class="white_key" data-key="E4"></div>
      <div class="white_key" data-key="F4"></div>
      <div class="black_key b3" data-key="F#4 / Gb4"></div>
      <div class="white_key" data-key="G4"></div>
      <div class="black_key b4" data-key="G#4 / Ab4"></div>
      <div class="white_key" data-key="A4"></div>
      <div class="black_key b5" data-key="A#4 / Bb4"></div>
      <div class="white_key" data-key="B4"></div>
      <div class="white_key" data-key="C5"></div>
      <div class="black_key b6" data-key="C#5 / Db5"></div>
      <div class="white_key" data-key="D5"></div>
      <div class="black_key b7" data-key="D#5 / Eb5"></div>
      <div class="white_key" data-key="E5"></div>
      <div class="white_key" data-key="F5"></div>
      <div class="black_key b8" data-key="F#5 / Gb5"></div>
      <div class="white_key" data-key="G5"></div>
      <div class="black_key b9" data-key="G#5 / Ab5"></div>
      <div class="white_key" data-key="A5"></div>
      <div class="black_key b10" data-key="A#5 / Bb5"></div>
      <div class="white_key" data-key="B5"></div>
      <div class="white_key last" data-key="C6"></div>
  `}
